...
export default function _1ChooseYourPackage(props) {
    ...
    const [payPackage, setPayPackage] = useState(1);
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-4 justify-between">
                                ...
                                <div className={`font-bold text-lg text-gradient-${option.title} capitalize`}>{option.title}</div>
                                <div className="font-bold text-xxs">
                                    <div>
                                        {`${option.cash} SOL${option.token > 0 ? ` & ${option.token}% Supply` : ''}`}
                                    </div>
                                </div>
                                <span className="text-xxxs">{option.desc}</span>
                            </div>
                        </div>
                    )
                })}
