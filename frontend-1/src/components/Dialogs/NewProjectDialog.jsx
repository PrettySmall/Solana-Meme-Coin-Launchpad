                                                    ...
                                                    <div className="w-full h-full">
                                                        ...
                                                        <div className="flex flex-col gap-6 justify-between">
                                                            <img
                                                                ...
                                                                alt="memeMark"
                                                            />
                                                            <span className="text-left ml-5 font-bold tracking-tight scale-x-125 text-base text-nowrap">MemeTools Account</span>
                                                            <span className="text-nowrap text-xxs">MemeToos New Account</span>
                                                        </div>
                                                    </div> :
                                                    <div className="w-full h-full">
                                                        <input
                                                        ...
                                                        <div className="flex flex-col gap-6 justify-between">
                                                            ...
                                                            <div className="font-bold text-xs">
                                                                ...
                                                                <div>
                                                                    {`${option.cash} SOL${option.token > 0 ? ` + ${option.token}% Supply` : ''}`}
                                                                </div>
                                                            </div>
