...
import RaydiumLaunchPage from './pages/RaydiumLaunchPage';
import PumpfunLaunchPage from './pages/PumpfunLaunchPage';
import FairLaunchPage from './pages/FairLaunchPage';
import Token2022LaunchPage from './pages/Token2022LaunchPage';
import Token2022ManagePage from './pages/Token2022ManagePage';
import PumpfunGhostLaunchPage from './pages/PumpfunGhostLaunchPage';
import RaydiumLaunchlabLaunchPage from './pages/RaydiumLaunchlabLaunchPage';
...
function App() {
  ...
  const initAllData = async (accessToken, user) => {
    ...
    //     const { data } = await axios.get(`${ENV.SERVER_URL}/api/v1/misc/load-jito-signers`,
    //       {
    //         headers: {
    //           "Content-Type": "application/json",
    ...
    //     const { data } = await axios.get(`${ENV.SERVER_URL}/api/v1/misc/load-all-logs`,
    //       {
    //         headers: {
    //           "Content-Type": "application/json",
    //           "MW-USER-ID": accessToken,
          ...
          user ?
            <Routes>
              ...
              {Object.keys(currentProject).length > 0 &&
                ...
                <Route path='/token-2022' element={<Token2022ManagePage />} />}
              <Route path='/launch-raydium' element={<RaydiumLaunchPage />} />
              <Route path='/launch-pumpfun' element={<PumpfunLaunchPage />} />
              <Route path='/launch-raydium-fair' element={<FairLaunchPage />} />
              <Route path='/launch-raydium-cpmm' element={<Token2022LaunchPage />} />
              <Route path='/launch-raydium-launchlab' element={<RaydiumLaunchlabLaunchPage />} />
