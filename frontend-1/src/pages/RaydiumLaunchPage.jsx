...
const RaydiumLaunchPage = () => {
    const { currentProject } = useContext(AppContext);
    const [selectedProject, setSelectedProject] = useState((currentProject.platform != 'raydium' || currentProject.paymentId == 0) ? { name: "New Project" } : { ...currentProject });
    ...
    useEffect(() => {
        if (step == 0)
            setSelectedProject((currentProject.platform != 'raydium' || currentProject.paymentId == 0) ? { name: "New Project" } : { ...currentProject });
        // setStep(0);
    }, [currentProject])
                    ...
                    <div className="w-full h-full flex flex-col gap-2">
                        ...
                        }
                        {
                            step == 4 && <div className="wizard-div overflow-auto p-6 flex flex-col items-center justify-center">
                                <BundleBuy className={"w-full h-full"} />
                            </div>
                        }
                    </div>
                </div>
...
export default RaydiumLaunchPage;
