        ...
        <div className="flex flex-col mt-12">
          <div className="mx-20 min-h-screen pb-40 content-center">
            ...
            <div className="flex gap-8 justify-center items-center flex-wrap">
              <div
                className="min-w-[300px] w-[300px] h-[410px] flex flex-col p-2 rounded-xl bg-gray-weight hover:brightness-125 hover:outline-4 hover:outline hover:outline-white"
              ...
              <div
                className="min-w-[300px] w-[300px] h-[410px] flex flex-col p-2 rounded-xl bg-gray-weight hover:brightness-125 hover:outline-4 hover:outline hover:outline-white"
                onClick={() => navigate("/launch-raydium-launchlab")}
              >
                <div className="w-full h-[100px] p-4 text-xl flex items-center bg-[#f4711a] rounded-2xl">
                  Raydium LaunchLab
                  <img className="w-auto h-14 p-2" src="/assets/img/launchlab_logo.png" alt="pumpfun" />
                </div>
                <div
                  className="flex flex-col gap-4 px-8 py-6 h-[30%] grow text-xs hover:brightness-125 cursor-pointer"
                >
                  <p className="text-left">
                    It creates tokens on raydium launchlab and snipes tokens with multiple wallets.
                  </p>
                  <div className="text-left">
                    First Block Snipe: <span className="text-[#1a51f4]">Yes</span>
                  </div>
                  <div className="text-left">
                    Dex: <span className="text-[#1a51f4]">Raydium LaunchLab</span>
                  </div>
                  <div className="text-left">
                    Curve: <span className="text-[#1a51f4]">LaunchLab</span>
                  </div>
                  <div className="text-left">
                    Tax Token: <span className="text-[#1a51f4]">No</span>
                  </div>
                  <div className="text-left">
                    Reward Distribute: <span className="text-[#1a51f4]">No</span>
                  </div>
                  <div className="text-left">
                    Protect from snipers: <span className="text-[#1a51f4]">Yes</span>
                  </div>
                </div>
              </div>
              {/* <div
                className="min-w-[300px] w-[300px] h-[410px] flex flex-col p-2 rounded-xl bg-gray-weight hover:brightness-125 hover:outline-4 hover:outline hover:outline-white"
                onClick={() => navigate("/launch-raydium")}
              >
                <div className="w-full h-[100px] p-4 text-xl flex items-center bg-[#1a51f4] rounded-2xl">
                  Raydium Bundle
                  <img className="w-14 h-14 p-2" src="/assets/img/raydium.png" alt="pumpfun" />
                </div>
                <div
                  className="flex flex-col gap-4 px-8 py-6 h-[30%] grow text-xs hover:brightness-125 cursor-pointer"
                >
                  <p className="text-left">
                    It creates tokens, creates pool and snipes tokens with multiple wallets on raydium.
                  </p>
                  <div className="text-left">
                    First Block Snipe: <span className="text-[#1a51f4]">Yes</span>
                  </div>
                  <div className="text-left">
                    Dex: <span className="text-[#1a51f4]">Raydium</span>
                  </div>
                  <div className="text-left">
                    Curve: <span className="text-[#1a51f4]">AMM</span>
                  </div>
                  <div className="text-left">
                    Tax Token: <span className="text-[#1a51f4]">No</span>
                  </div>
              ...
              <div
                className="min-w-[300px] w-[300px] h-[410px] flex flex-col p-2 rounded-xl bg-gray-weight hover:brightness-125 hover:outline-4 hover:outline hover:outline-white"
                onClick={() => navigate("/launch-raydium-fair")}
              >
                <div className="w-full h-[100px] p-4 text-xl flex items-center bg-[#f94b60] rounded-2xl">
                  Raydium Fair Launch
                  <img className="w-14 h-14 p-2" src="/assets/img/raydium.png" alt="pumpfun" />
                </div>
                <div
                ...
                >
                  <p className="text-left">
                    It creates tokens, creates pool and buy tokens with multiple wallets on raydium.
                  </p>
                  <div className="text-left">
                    First Block Snipe: <span className="text-[#f94b60]">No</span>
                  </div>
                  <div className="text-left">
                    Dex: <span className="text-[#f94b60]">Raydium</span>
                  </div>
                  <div className="text-left">
                    Curve: <span className="text-[#f94b60]">AMM</span>
                  </div>
                  <div className="text-left">
                    Tax Token: <span className="text-[#f94b60]">No</span>
                  </div>
                  <div className="text-left">
                    Reward Distribute: <span className="text-[#f94b60]">No</span>
                  </div>
                  <div className="text-left">
                    Protect from snipers: <span className="text-[#f94b60]">Yes</span>
                  </div>
                </div>
              </div>
              <div
                className="min-w-[300px] w-[300px] h-[410px] flex flex-col p-2 rounded-xl bg-gray-weight hover:brightness-125 hover:outline-4 hover:outline hover:outline-white"
                onClick={() => navigate("/launch-raydium-cpmm")}
              >
                <div className="w-full h-[100px] p-4 text-xl flex items-center bg-[#09ca96] rounded-2xl">
                  Token 2022 Launch
                  <img className="w-14 h-14 p-2" src="/assets/img/raydium.png" alt="pumpfun" />
                </div>
                <div
                ...
                >
                  <p className="text-left">
                    It creates tax token, creates pool and snipes tokens with multiple wallets on raydium cpmm.
                  </p>
                  <div className="text-left">
                    First Block Snipe: <span className="text-[#09ca96]">Yes</span>
                  </div>
                  <div className="text-left">
                    Dex: <span className="text-[#09ca96]">Raydium</span>
                  </div>
                  <div className="text-left">
                    Curve: <span className="text-[#09ca96]">CPMM</span>
                  </div>
                  <div className="text-left">
                    Tax Token: <span className="text-[#09ca96]">Yes</span>
                  </div>
                  <div className="text-left">
                    Reward Distribute: <span className="text-[#09ca96]">Yes</span>
                  </div>
                  <div className="text-left">
                    Protect from snipers: <span className="text-[#09ca96]">Yes</span>
                  </div>
                </div>
              </div>
            </div>
