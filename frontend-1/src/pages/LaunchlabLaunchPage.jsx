...
const LaunchlabLaunchPage = () => {
    const { currentProject } = useContext(AppContext);
    const [selectedProject, setSelectedProject] = useState((currentProject.platform != 'raydium.launchlab' || currentProject.paymentId == 0) ? { name: "New Project" } : { ...currentProject });
    ...
    useEffect(() => {
        if (step == 0)
            setSelectedProject((currentProject.platform != 'raydium.launchlab' || currentProject.paymentId == 0) ? { name: "New Project" } : { ...currentProject });
        // setStep(0);
    }, [currentProject])
        ...
        <div className="w-screen h-screen flex flex-col max-[1800px]:items-start items-center overflow-auto">
            <div className="flex flex-col gap-6 items-center mx-6 my-3">
                ...
                <Card className="mx-auto !w-[1200px] !p-6 flex flex-col gap-6 rounded-3xl border-4 border-card-border">
                    <div className="font-conthrax text-lg mx-auto font-medium">Raydium LaunchLab Token Creation</div>
                    ...
                    <div className="flex justify-center items-center font-conthrax">
                        ...
                        <div className="w-36 flex flex-col items-center">
                            ...
                            <div className={`mt-2.5 ${step > 0 ? "text-gradient-blue-to-purple" : "text-gray-label"} text-nowrap`}>Create Raydium LaunchLab Token</div>
                        </div>
                                    ...
                                    <div className="flex font-conthrax justify-between items-center">
                                        <div className="flex gap-2 items-center">
                                            ...
                                            <div className={`text-xxs ${step > 1 ? "text-step-gradient" : "text-gray-label"}`}>
                                                Create Raydium LaunchLab Token
                                            </div>
                                        </div>
                                        <div className="flex gap-6 items-center">
...
export default RaydiumLaunchlabLaunchPage;
